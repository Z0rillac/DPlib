...
execute in dplib.datetime:void if data block 0 1 0 profile.properties run scoreboard players operation request.state dplib.datetime.main = #request.received dplib.enum