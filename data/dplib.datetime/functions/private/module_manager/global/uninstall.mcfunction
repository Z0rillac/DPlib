#> dplib.datetime:private/module_manager/global/uninstall
...
execute if score #loaded_instances dplib.temp matches ..0 run function dplib.datetime:private/module_manager/global/uninstall_if