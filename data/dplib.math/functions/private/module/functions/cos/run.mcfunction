#> dplib.math:private/module/functions/cos/run
# @private
...
execute unless score $scale dplib.math.in matches 0 run function dplib.math:private/module/functions/cos/scale