#> dplib.logger:private/module_manager/global/load
...
function dplib.logger:private/module_manager/global/enum
function dplib.logger:private/module_manager/global/const