#> dplib:private/math/functions/cos/run
# @private
...
# $out = term_1/term_2
scoreboard players operation $out dplib.out = #term_1 dplib.temp
scoreboard players operation $out dplib.out /= #term_2 dplib.temp

scoreboard players set $scaled dplib.out 0
execute unless score $scale dplib.in matches 0 run function dplib:private/math/functions/cos/scale