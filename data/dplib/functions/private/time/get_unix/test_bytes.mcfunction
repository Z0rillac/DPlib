#> dplib:private/time/get_unix/test_bytes
...
execute store result score #b0 dplib.temp run data get storage dplib:time root.get_unix.bytes[0] 1
execute store result score #b1 dplib.temp run data get storage dplib:time root.get_unix.bytes[1] 1
execute store result score #b2 dplib.temp run data get storage dplib:time root.get_unix.bytes[2] 1
execute store result score #b3 dplib.temp run data get storage dplib:time root.get_unix.bytes[3] 1
execute store result score #b4 dplib.temp run data get storage dplib:time root.get_unix.bytes[4] 1
execute store result score #b5 dplib.temp run data get storage dplib:time root.get_unix.bytes[5] 1
execute store result score #b6 dplib.temp run data get storage dplib:time root.get_unix.bytes[6] 1
execute store result score #b7 dplib.temp run data get storage dplib:time root.get_unix.bytes[7] 1
