#> dplib.benchmark:private/module_manager/global/load
...
function dplib.benchmark:private/module_manager/global/enum
function dplib.benchmark:private/module_manager/global/const